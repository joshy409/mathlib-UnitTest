...
bool runUnitTests() {
	...
	v3a = Vector3(13.5f, -48.23f, 862);
	v3b = v3a.getNormalised();
	v4a = Vector4(243, -48.23f, 862, 0);
	v4b = v4a.getNormalised();
	...
	m4a = Matrix4::rotationX(4.5f);
	//m3b = m3b.rotation(1.76f); rotationY for mat3 not implemented
	m4b = Matrix4::rotationY(-2.6f);
	m3c = m3c.rotation(9.62f);
	m4c = Matrix4::rotationZ(0.72f);
	...
	TEST("Vector3 matrix transform", v3b, Vector3(844.07769f, -48.2299995422f, -175.38145f));
	...
	TEST("Matrix3 multiply1", m3d, Matrix3(-0.981004655361f, 0.129707172513f, 0.14424264431f, 0.193984255195f, 0.655946731567f, 0.729454636574f, 0, 0.743579149246f, -0.668647944927f));
	TEST("Matrix4 multiply2", m4d, Matrix4(-0.644213855267f, -0.565019249916f, 0.515501439571f, 0, -0.659384667873f, 0.751805722713f, 0, 0, -0.387556940317f, -0.339913755655f, -0.856888711452f, 0, 0, 0, 0, 1));
